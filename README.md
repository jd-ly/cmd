...
[![Go Report Card](https://goreportcard.com/badge/github.com/jd-ly/cmd)](https://goreportcard.com/report/github.com/jd-ly/cmd)
...
------------
```bash
go get -u github.com/jd-ly/cmd/revel
```
